...
# URL definition
UNM_SERV_GIT_REPO="https://gh.jiujiukan.ml/https://github.com/UnblockNeteaseMusic/server"
UNM_SERV_SCRIPT_URL="https://gh.jiujiukan.ml/https://raw.githubusercontent.com/UnblockNeteaseMusic/install-scripts/master/server/install.sh"
